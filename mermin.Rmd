...
When the settings are the same, the findings agree with local determinism: the lights always flash the same colour. However, when the settings are different, the lights are the same on only $1/4$ of trials. This is lower than the $1/2$ predicted by the local determinism setup.
