...
Out of curiosity, I gave the circuit above a go on an IBM Quantum computer (ibmq_jakarta). The measurement outcomes were the same on `r 13.8+12.8`% of 1,000 trials, 95% CI = [23.9%, 29.5%]. This matches the predictions of quantum mechanics and is well below 50%.
