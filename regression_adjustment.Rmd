...
```{r}
avg_comparisons(gmod, variables = "mbsmoke", type = "response")
```

Not quite -239.6392 (SE = 23.82402), but very close.
...
Again very close to -223.3017 (SE = 22.7422)!
...
I've packaged up a function ready for bootstrapping, which applied to the original data replicates teffects:
