---
title: "Sharp variance bounds for SATE: giving Mikhaeil and Green (2024) a test drive"
author: Andi Fugard
date: 9 Nov 2024
output: 
  html_notebook: 
...
This problem was pointed out by Neyman (1923/1990). Reichardt and Gollob (1999) independently rediscovered the problem and suggested a way to get a less conservative standard error based on the reliability of the outcome measure. This gives an upper bound on the correlation.  Aronow, Green, and Lee (2014) proved a result that puts bounds on the correlation based on the observed marginal distribution of outcomes. They also helpfully provided R code to do the sums; however, this approach only works for a model without any covariates.
