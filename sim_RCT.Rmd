...
Let's simulate some data where we know the average treatment effect. This is an efficacy trial, so we are only interested in the average treatment effect for the study participants. There is still an inferential problem since not everyone gets treatment and not everyone gets control.
...
We only see one of the potential outcomes, depending on which was realised, hence the NAs.
