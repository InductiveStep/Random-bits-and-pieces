...
Surprisingly, {_eefAnalytics_} does not seem to follow EEF guidance. I can, however, replicate what it does using {_lmeInfo_}. Also {_lmeInfo_} gives me the answer I do expect.
