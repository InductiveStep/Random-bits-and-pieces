...
The SMD we're looking for is `r es`.
...
This first example includes only treatment group and random effect, with no covariate. It should provide the correct answer, though this isn't generally a good idea as the CI will be too wide if your covariates explain variation in the outcome:
