...
tic()
res_list$big1  <- rnorm_mean(2^26)
res_list$big2  <- rnorm_mean(2^26)
toc()
```
...
tic()
future_list$big1  <- rnorm_mean(2^26) |> future(seed = TRUE)
future_list$big2  <- rnorm_mean(2^26) |> future(seed = TRUE)
future_list$huge  <- rnorm_mean(2^27) |> future(seed = TRUE)
toc()
```
